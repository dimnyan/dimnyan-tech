...
function ContactMe() {
  return (
    <div className="md:flex py-20 md:px-24 md:py-60 px-12 bg-img-contact-banner lg:bg-fixed bg-center bg-cover">
      <motion.div
      ...
      >
        <h2 className="text-2xl md:text-5xl font-extrabold mb-4 text-center">
